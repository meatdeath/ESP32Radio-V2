...
void readIOprefs()
{
  ...
  struct iosetting klist[] = {                            // List of I/O related keys
    ...
    { "pin_tft_dc",    &ini_block.tft_dc_pin,       17 }, // Display SPI version
...
void setup()
{
  ...
  if ( dsp_ok )                                          // Init okay?
  {
    ...
    dsp_setTextColor ( COLOR_GREY ) ;                          // Info in grey
