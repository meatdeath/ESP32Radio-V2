...
{                                                           // One text line is 8 pixels
  ...
  { false, COLOR_CYAN,   20, 64, "" },                            // line in the middle
  { false, COLOR_YELLOW, 90, 32, "" },                            // line at the bottom
  { false, COLOR_GREEN,  90, 32, "" }                             // line at the bottom for rotary encoder
} ;
...
bool NEXTION_dsp_begin ( int8_t rx, int8_t tx )
{
  ...
  NEXTION_nextioncmd ( "cls COLOR_BLACK" ) ;                      // Erase screen, non vital
