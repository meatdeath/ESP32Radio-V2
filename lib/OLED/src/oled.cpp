...
{                                                     // One text line is 8 pixels
  ...
  { false, COLOR_CYAN,    8, 32, "" },                      // 4 lines in the middle
  { false, COLOR_YELLOW, 40, 22, "" },                      // 3 lines at the bottom, leave room for indicator
  { false, COLOR_GREEN,  40, 22, "" }                       // 3 lines at the bottom for rotary encoder
} ;
...
void OLED::clear()
{
  ...
  {
    memset ( ssdbuf[pg].page, COLOR_BLACK, SCREEN_WIDTH ) ;    // Clears all pixels of 1 page
