...
scrseg_struct     LCD1602_tftdata[TFTSECS] =                // Screen divided in 4 segments
                      {
                        { false, COLOR_WHITE,   0,  0, "" },      // 1 top line (dummy)
                        { false, COLOR_WHITE,   0,  0, "" },      // 8 lines in the middle
                        { false, COLOR_WHITE,   0,  0, "" },      // 4 lines at the bottom
                        { false, COLOR_WHITE,   0,  0, "" }       // 4 lines at the bottom for rotary encoder
                      } ;
